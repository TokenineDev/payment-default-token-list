...
const lorlend = require("./tokens/lorlend-pay-busd.json")
module.exports = function buildList() {
  const parsed = version.split(".");
  return {
    name: "Lorlend Tokens List",
    ...
    tags: {},
    logoURI:
      "https://raw.githubusercontent.com/TokenineDev/payment-default-token-list/main/src/images/lorlend.png",
    keywords: ["Lorlend Pay", "default"],
    tokens: [
      ...lorlend
    ]
